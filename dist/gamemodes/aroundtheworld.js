...
class AroundTheWorld extends gamemode_1.GameModeBase {
    constructor(players, remainingShots = 3, turn = 0, end = false) {
        ...
        this.players.forEach(element => element.setScore(board_enum_1.Board.NINETEEN));
    }
    startGame() {
        return __awaiter(this, void 0, void 0, function* () {
            // this.loop(this.checkStage).catch(reason => console.error(reason));
    ...
    checkStage(player, playerShot) {
        ...
        if (player.score === null && playerShot[0] === board_enum_1.Board["ONE"] || player.score + 1 === playerShot[0]) {
